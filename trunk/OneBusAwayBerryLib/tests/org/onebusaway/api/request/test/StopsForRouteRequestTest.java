...
import org.onebusaway.api.request.ObaStopsForRouteRequest;
import org.onebusaway.api.request.ObaStopsForRouteResponse;
...
public class StopsForRouteRequestTest extends ObaTestCase {
    ...
    public void testNoShapes() {
        ObaStopsForRouteResponse response = (ObaStopsForRouteResponse)
            new ObaStopsForRouteRequest.Builder(getContext(), "1_44")
